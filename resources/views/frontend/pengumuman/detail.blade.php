...
<div class="col-md-12 col-lg-8">
    <div class="row">
        ...
        <div class="col-sm-12">
            <br><br><br><br>
            <img src="{{asset('uploads/'.$pengumuman_detail->gambar)}}" alt="">
            &nbsp;

            <h2 class="pt-20"><b>{{$pengumuman_detail->judul}}</b></h2>

            <ul class="list-li-mr-20 pt-10 pb-20">
                <li class="color-lite-black">by <a href="javascipt::void(0)" class="color-black"><b>{{$pengumuman_detail->User->name}},</b></a>
                    {{$pengumuman_detail->created_at->diffForHumans()}}</li>
                <br>&nbsp;<br>
