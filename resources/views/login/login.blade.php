...
<head>
  ...
  <title>Login | SipakdeJugo</title>
  <link href="{{asset('back-end/images/Kabupaten_Jepara-213x300.png')}}" rel="icon">
  ...
  <style type="text/css">
    ...
    .card-login{
      background-position: center;
      background-image: url('{{ asset('backend/login/images/bookread.png')  }}');
      background-size: cover;
    }
  </style>
</head>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><img src="{{asset('frontend/images/logo.png')}}" class="Logo" style="width: 100%;height: 100%;margin-left: -15px"></h1>
                  </div>
